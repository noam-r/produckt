...
def upgrade():
    ...
    op.add_column('users', sa.Column('budget_updated_by', sa.String(36), nullable=True))
    ...
    op.add_column('initiatives', sa.Column('max_questions_updated_by', sa.String(36), nullable=True))
